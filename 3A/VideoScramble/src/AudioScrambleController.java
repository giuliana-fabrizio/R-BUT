...
public class AudioScrambleController {
    ...
    public static void scramblesAudio(double[] samples, double sampleRate) {
        ...
        for (int i = 0; i < len_samples; i++) {
            // Calcul du temps associé à l'échantillon actuel.
            time = i / sampleRate;

            // Multiplie l'élément de samples à la position i par une sinusoïde modulée dans le temps.
            // Cela introduit un effet de modulation d'amplitude dans le signal audio.
            // On passe de 0 - 12.8kHz à -12.8kHz - 0
